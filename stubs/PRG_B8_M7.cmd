...
#
#
MACRO  Dummy Command : 8100 0907 0000 : Macro ID tag 0x0907
***Wait 1s
...
***Wait 1s
MACRO  Set Relays & Muxes : 8a01 00c0 0092 : Density mode (+-32V) P1 and P2 Gain 0.05
***Wait 1s
MACRO  Set Filter : 9b00 0000 0000 : Digital realtime filters off!
***Wait 1s
MACRO  Denisty Fix Bias : 8d05 9494 0000 : Bias P1 & P2 5V
***Wait 1s
...
***Wait 1s
MACRO  Denisty Sweep : 8c08 00f7 0008 : Coarse Density sweep probe 1, / , 3.3s [-30V..30V].
***Wait 1s
MACRO  Denisty Fix Bias : 8d07 9494 0000 : Time series off, sweeps on and bias off
***Wait 1s
...
***Wait 1s
MACRO  Denisty Sweep : 8c08 00f7 0010 : Coarse Density sweep probe 2, / , 3.3s [-30V..30V]
***Wait 1s
MACRO  AQP Hold : b000 0101 0000 : Default Hold 1 AQP
***Wait 1s
...
MACRO  Fillout Buffer : b303 0000 0000 : Fill out buffer with data from  adc20 source 
***Wait 1s
MACRO  Denisty Fix Bias : 8d04 9494 0000 : Density bias P1 & P2 5V, no 16 bit, terminate sweep
***Wait 1s
MACRO  AQP Hold : b000 0101 0000 : Default Hold 1 AQP
***Wait 1s
MACRO  Sample Hold : b204 0000 0000 : Holds until 20 ADC
...
MACRO  Fillout Buffer : b303 0000 0000 : Fill out buffer with data from  adc20 source 
***Wait 1s
MACRO  Denisty Fix Bias : 8d04 9494 6464 : Density bias P1 & P2 5V,Duration P1 & P2 1600 smpls
***Wait 1s
