...
#
#
MACRO  Dummy Command : 8100 0105 0000 : Macro ID tag 0x0105
***Wait 1s
...
***Wait 1s
MACRO  Denisty Sweep : 8c00 00f6 0008 : Sweep P1 1.7s [-32V..+30V] normal TM
***Wait 1s
...
***Wait 1s
MACRO  Sample Hold : b203 0000 0000 : Hold until prb 1 and 2 full 
***Wait 1s
...
***Wait 1s
MACRO  Denisty Sweep : 8c00 00f6 0010 : Sweep P2 1.7s [-32V..+30V] normal TM
***Wait 1s
MACRO  AQP Hold : b000 0101 0000 : Default Hold 1 AQP
***Wait 1s
MACRO  Sample Hold : b203 0000 0000 : Hold until prb 1 and 2 full
