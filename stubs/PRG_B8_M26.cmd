...
#
#
MACRO  Dummy Command : 8100 0926 0000 : Macro ID tag 0x0926
***Wait 1s
...
***Wait 1s
MACRO  Denisty Sweep : 8c08 01f7 000b : Coarse Density sweep probe 1, /\ , 3.3s [-30V..30V].
***Wait 1s
...
***Wait 1s
MACRO  Denisty Sweep : 8c08 01f7 0013 : Coarse Density sweep probe 2, /\ , 3.3s [-30V..30V]
***Wait 1s
MACRO  AQP Hold : b000 0101 0000 : Default Hold 1 AQP
***Wait 1s
