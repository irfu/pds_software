...
#
#
MACRO  Dummy Command : 8100 0207 0000 : Macro ID tag 0x0207
***Wait 1s
...
***Wait 1s
MACRO  E Fix Bias : 8e00 7f7f 0099 : Sets up efield bias and duration 512 smpls p1 & p2
***Wait 1s
MACRO  Set Filter : 9b03 0020 0020 : Digital Filter Cut Off 2344 Hz p1 and p2
***Wait 1s
MACRO  Resampling : 9a00 0003 0003 : Downsampling 4 times p1 and p2
***Wait 1s
...
***Wait 1s
MACRO  Set Subheader : b735 0000 0000 : Sets sub header and ID code
***Wait 1s
MACRO  Fillout Buffer : b301 0000 0000 : Empty p1 to buffer
***Wait 1s
MACRO  Set Subheader : b736 0000 0000 : Sets sub header and ID code
***Wait 1s
