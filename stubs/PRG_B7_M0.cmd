...
#
#
MACRO  Dummy Command : 8100 0800 0000 : Macro ID tag 0x0800
***Wait 1s
...
***Wait 1s
MACRO  Set Moving Avrg & ADC Params : 9c73 0706 0007 : 20 bit 1798 smpls, down 128 times, truncated
***Wait 1s
...
***Wait 1s
MACRO  E Fix Bias : 8e0c 779e 0000 : Sets up efield bias P1 -10nA P2 3nA p1 & p2 (duration ignored)
***Wait 1s
MACRO  E Fix Bias : 8e06 779e 0c0c : Sets duration 192 smpls p1 & p2 (bias ignored)
***Wait 1s
...
***Wait 1s
MACRO  E Fix Bias : 8e06 779e 0000 : Ensures no 16 bit following AQPs (Bias value ignored)
***Wait 1s
