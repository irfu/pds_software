...
#
#
MACRO  Dummy Command : 8100 0814 0000 : Macro ID tag 0x0814
***Wait 1s
...
***Wait 1s
MACRO  Denisty Fix Bias : 8d05 087f 0100 : P1 -30V, 16 smpls, sweep allowed
***Wait 1s
...
***Wait 1s
MACRO  Denisty Fix Bias : 8d04 087f 0100 : P1 bias -30V, 16 samples, sweep disallowed
***Wait 1s
MACRO  AQP Hold : b000 0101 0000 : AQP hold 1 allow sampling
***Wait 1s
...
MACRO  Fillout Buffer : b301 0000 0000 : Empty p1 to buffer
***Wait 1s
MACRO  Denisty Fix Bias : 8d06 087f 0000 : Ensures no 16 bit following AQPs
***Wait 1s
