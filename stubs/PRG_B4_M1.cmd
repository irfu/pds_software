...
#
#
MACRO  Dummy Command : 8100 0501 0000 : Macro ID tag 0x0501
***Wait 1s
...
***Wait 1s
MACRO  Denisty Fix Bias : 8d00 7f7f 0000 : Set fix density bias & durations
***Wait 1s
...
***Wait 1s
MACRO  Denisty Sweep : 8cf0 01e8 0009 : Setup sweep on p1 [28V..-28V]  6.2 s
***Wait 1s
...
***Wait 1s
MACRO  Denisty Sweep : 8cf0 01e8 0011 : Setup sweep on p2 [28V..-28V]  6.2 s
***Wait 1s
MACRO  AQP Hold : b000 0101 0000 : AQP hold 1 allow sampling
***Wait 1s
MACRO  Sample Hold : b203 0000 0000 : Sample hold until p1 & p2 finished
...
***Wait 1s
MACRO  AQP Hold : b000 0200 0000 : Hold 2 AQPs
***Wait 1s
MACRO  Goto : b100 0013 0000 : Go N steps back in macro
***Wait 1s
