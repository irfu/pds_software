...
#
#
MACRO  Dummy Command : 8100 0306 0000 : Macro ID tag 0x0306
***Wait 1s
...
***Wait 1s
MACRO  Denisty Sweep : 8caf 0338 990d : Fine sweep P1, Offset 9,1.4 s
***Wait 1s
...
***Wait 1s
MACRO  Denisty Sweep : 8caf 0338 9915 : Fine sweep P2, Offset 9,1.4 s
***Wait 1s
MACRO  AQP Hold : b000 0101 0000 : Default Hold 1 AQP
***Wait 1s
MACRO  Sample Hold : b203 0000 0000 : Hold until prb 1 & prb 2 full
