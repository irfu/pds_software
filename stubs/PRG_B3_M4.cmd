...
#
#
MACRO  Dummy Command : 8100 0404 0000 : Macro ID tag 0x0404
***Wait 1s
MACRO  Set Telemetry Rate : 8202 0000 0000 : Normal Telemetry
***Wait 1s
...
***Wait 1s
MACRO  Set Moving Avrg & ADC Params : 9c6f 0506 0005 : 1286 samples p1+p2 21.4 s,full 20 bit Downsample to 2 Hz
***Wait 1s
...
***Wait 1s
MACRO  Set Subheader : b71a 0000 0000 : E-FIELD P1 & P2 INTERLEAVED 20 BIT ADCS RAW BIPOLAR
***Wait 1s
