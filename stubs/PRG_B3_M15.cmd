...
#
#
MACRO  Dummy Command : 8100 0415 0000 : Macro ID tag 0x0415
***Wait 1s
...
***Wait 1s
MACRO  Denisty Fix Bias : 8d05 087f 0000 : Density bias P1 -30V, sweep enabled (GOTO goal)
***Wait 1s
...
***Wait 1s
MACRO  Denisty Fix Bias : 8d07 087f 0000 : Turn off time series, sweeps allowed
***Wait 1s
...
***Wait 1s
MACRO  Denisty Fix Bias : 8d04 087f 0000 : Density bias P2 0V (ignored), P1 -30V, no 16 bit, terminate sweep
***Wait 1s
MACRO  AQP Hold : b000 0101 0000 : Default Hold 1 AQP
***Wait 1s
