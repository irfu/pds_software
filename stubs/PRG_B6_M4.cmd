...
#
#
MACRO  Dummy Command : 8100 0704 0000 : Macro ID tag 0x0704
***Wait 1s
...
***Wait 1s
MACRO  E Fix Bias : 8e04 d6d6 9700 : Sets P1 efield bias -30nA and duration 2416 smpls
***Wait 1s
...
***Wait 1s
MACRO  Set Subheader : b715 0000 0000 : Sets sub header and ID code E_P1_16BIT_RAW
***Wait 1s
...
***Wait 1s
MACRO  Set Subheader : b718 0000 0000 : Sets sub header and ID code E_P1_TRNC_20_BIT_RAW_BIP
***Wait 1s
