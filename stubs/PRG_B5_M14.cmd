...
#
#
MACRO  Dummy Command : 8100 0614 0000 : Macro ID tag 0x0614
***Wait 1s
...
***Wait 1s
MACRO  Denisty Fix Bias : 8d05 0808 0000 : Sets fix bias -30V
***Wait 1s
MACRO  Set Moving Avrg & ADC Params : 9c1f 06fd 0001 : 1789 smpls moving average, dowsampled 2 times , full 20bit, dowsampled 2 times 
***Wait 1s
MACRO  Resampling : 9a00 007f 0000 : Keep every 128 sample p1
***Wait 1s
MACRO  Denisty Sweep : 8c08 00f8 0008 : Coarse Density sweep probe 1, /, 6.6s [-30V..30V]
***Wait 1s
...
***Wait 1s
MACRO  Resampling : 9a00 0000 007f : Keep every 128 sample p2
***Wait 1s
...
MACRO  Fillout Buffer : b303 0000 0000 : Fill out buffer with data from  adc20 source 
***Wait 1s
MACRO  Denisty Fix Bias : 8d04 0808 8080 : Density bias -30V ,Duration P1 & P2 2048 smpls
***Wait 1s
