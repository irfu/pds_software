...
#
#
MACRO  Dummy Command : 8100 0616 0000 : Macro ID tag 0x0616
***Wait 1s
...
***Wait 1s
MACRO  Denisty Fix Bias : 8d05 7ff8 0000 : Density bias P2 +31V, sweep enabled (GOTO goal)
***Wait 1s
...
***Wait 1s
MACRO  Denisty Fix Bias : 8d07 7ff8 0000 : Turn off time series, sweeps allowed
***Wait 1s
...
***Wait 1s
MACRO  Denisty Fix Bias : 8d04 7ff8 0000 : Density bias P1 0V (ignored), P2 +30V, no 16 bit, terminate sweep
***Wait 1s
MACRO  AQP Hold : b000 0101 0000 : Default Hold 1 AQP
***Wait 1s
