...
#
#
MACRO  Dummy Command : 8100 0411 0000 : Macro ID tag 0x0411
***Wait 1s
...
***Wait 1s
MACRO  Set Moving Avrg & ADC Params : 9c0f 0660 0000 : 20 Bit ADC P1 & P2 1632 Samples, No MA 
***Wait 1s
...
***Wait 1s
MACRO  Resampling : 9a00 0000 007f : Downsampling 128x for P2 sweep
***Wait 1s
...
***Wait 1s
MACRO  Set Subheader : b730 0000 0000 : Sets sub header and ID code 0x30 E-P1 D-P2 full20bit A20
***Wait 1s
...
***Wait 1s
MACRO  Set Subheader : b730 0000 0000 : Sets sub header and ID code
***Wait 1s
...
***Wait 1s
MACRO  E Fix Bias : 8e04 7f7f 1600 : Sets up P1 efield bias (ignored) and duration 352
***Wait 1s
MACRO  Denisty Fix Bias : 8d06 7f7f 0016 : Sets P2 dens duration 352 smpls (bias ignored)
***Wait 1s
