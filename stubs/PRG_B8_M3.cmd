...
#
#
MACRO  Dummy Command : 8100 0903 0000 : Macro ID tag 0x0903
***Wait 1s
...
***Wait 1s
MACRO  Denisty Fix Bias : 8d07 f8f8 0000 : Time series off, sweeps on and bias off
***Wait 1s
...
MACRO  Fillout Buffer : b303 0000 0000 : Fill out buffer with data from  adc20 source 
***Wait 1s
MACRO  Denisty Fix Bias : 8d04 f8f8 6464 : Density bias P1 & P2 30V,Duration P1 & P2 1600 smpls
***Wait 1s
