...
#
#
MACRO  Dummy Command : 8100 0906 0000 : Macro ID tag 0x0906
***Wait 1s
MACRO  Set Telemetry Rate : 8202 0000 0000 : Sets telemetry rate
***Wait 1s
...
***Wait 1s
MACRO  Denisty Fix Bias : 8d04 7f7f 0600 : Sets fix bias and duration strtgy 2, 96 samples P1
***Wait 1s
...
***Wait 1s
MACRO  Set Subheader : b701 0000 0000 : Sets sub header RAW P1
***Wait 1s
