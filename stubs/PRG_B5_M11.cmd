...
#
#
MACRO  Dummy Command : 8100 0611 0000 : Macro ID tag 0x0611
***Wait 1s
...
***Wait 1s
MACRO  Denisty Fix Bias : 8d05 0404 0000 : Bias P1P2 -30V
***Wait 1s
...
***Wait 1s
MACRO  Denisty Fix Bias : 8d07 0404 0000 : Turn off time series, sweeps allowed
***Wait 1s
...
MACRO  Fillout Buffer : b303 0000 0000 : Fill out buffer with data from  adc20 source 
***Wait 1s
MACRO  Denisty Fix Bias : 8d04 0404 0000 : Density bias P1P2 -30V, no 16 bit, terminate sweep
***Wait 1s
MACRO  AQP Hold : b000 0101 0000 : Default Hold 1 AQP
***Wait 1s
MACRO  Sample Hold : b204 0000 0000 : Holds until 20 ADC
...
***Wait 1s
MACRO  Denisty Fix Bias : 8d04 0404 0b00 : Density bias P1P2 -30V,Duration P1 176 smpls
***Wait 1s
