...
#
#
MACRO  Dummy Command : 8100 0905 0000 : Macro ID tag 0x0905
***Wait 1s
...
***Wait 1s
MACRO  Set Relays & Muxes : 8a01 00c0 009a : Density mode (+-32V) P1 Gain 0.05 P2 Gain 1.0
***Wait 1s
MACRO  Set Filter : 9b00 0000 0000 : Digital realtime filters off!
***Wait 1s
MACRO  Denisty Fix Bias : 8d05 f83c 0000 : Bias P1 30V & P2 -17V
***Wait 1s
...
***Wait 1s
MACRO  Denisty Sweep : 8c3c 0167 0008 : Coarse Density sweep probe 1, / , 1.4s [-17V..31.0V].
***Wait 1s
...
***Wait 1s
MACRO  Denisty Sweep : 8c3c 0167 0010 : Coarse Density sweep probe 2, / , 1.4s [-17V..31V]
***Wait 1s
MACRO  AQP Hold : b000 0101 0000 : Default Hold 1 AQP
***Wait 1s
...
MACRO  Fillout Buffer : b303 0000 0000 : Fill out buffer with data from  adc20 source 
***Wait 1s
MACRO  Denisty Fix Bias : 8d04 f83c 0000 : Density bias P1 30V & P2 -17V, no 16 bit, terminate sweep
***Wait 1s
MACRO  AQP Hold : b000 0101 0000 : Default Hold 1 AQP
***Wait 1s
MACRO  Sample Hold : b204 0000 0000 : Holds until 20 ADC
...
MACRO  Fillout Buffer : b303 0000 0000 : Fill out buffer with data from  adc20 source 
***Wait 1s
MACRO  Denisty Fix Bias : 8d04 f83c 0606 : Density bias P1 30V & P2 -17V,Duration P1 & P2 96 smpls
***Wait 1s
