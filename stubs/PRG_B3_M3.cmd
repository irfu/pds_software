...
#
#
MACRO  Dummy Command : 8100 0403 0000 : Macro ID tag 0x0403
***Wait 1s
...
***Wait 1s
MACRO  Set Filter : 9b03 0060 0060 : Digital Filter Cut Off 586 Hz p1 and p2
***Wait 1s
MACRO  Resampling : 9a00 000f 000f : Downsampling 16 times p1 and p2
***Wait 1s
...
***Wait 1s
MACRO  Set Subheader : b739 0000 0000 : Sets sub header and ID code
***Wait 1s
MACRO  Fillout Buffer : b301 0000 0000 : Empty p1 to buffer
***Wait 1s
MACRO  Set Subheader : b73a 0000 0000 : Sets sub header and ID code
***Wait 1s
