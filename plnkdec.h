...
extern int DeleteP(prp_type *,char *,int);                      // Delete by name and occurrence
...
extern int FindP(prp_type *,property_type **,char *,int,char);  // Find by name and occurrence
...
extern int SetPT(prp_type *,property_type *prop,int);           // Set by property type and occurrence
extern int SetP(prp_type *,char *,char *,int);                  // Set value by name and occurrence 
extern int InsertA(prp_type *,char *,char *,char *,int);        // Insert after occ occurrence of name
extern int InsertAV(prp_type *,char *,char *,unsigned int,int); // Same as insert_a but value is integer 
extern int InsertB(prp_type *,char *,char *,char *,int);        // Insert before occ occurrence of name
